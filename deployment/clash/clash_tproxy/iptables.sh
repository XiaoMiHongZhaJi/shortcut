...
iptables -t mangle -A OUTPUT -p tcp -m owner --uid-owner debian-transmission -j RETURN
iptables -t mangle -A OUTPUT -p udp -m owner --uid-owner debian-transmission -j RETURN
